...
$s1_Out_Data = getShiftStats($conn, $viewDate, $safe2Id, $zapmoId, false, $cutoffMinutes);
$s1_In_Data  = getShiftStats($conn, $viewDate, $zapmoId, $safe2Id, false, $cutoffMinutes);

$s1_Wip      = $s1_Out_Data['weight'] - $s1_In_Data['weight'];

// 4. CALCULATE SHIFT 2 ONLY
$s2_Out_Data = getShiftStats($conn, $viewDate, $safe2Id, $zapmoId, true, $cutoffMinutes);
$s2_In_Data  = getShiftStats($conn, $viewDate, $zapmoId, $safe2Id, true, $cutoffMinutes);
...
<div class="container pb-5">
    ...
    <div class="table-custom p-1 shadow-lg">
        <table class="table table-dark table-hover mb-0 align-middle">
            ...
            <tbody>
                <?php 
                $stmtList = executeQuery($conn, $sqlList, [$viewDate, $safe2Id, $zapmoId, $zapmoId, $safe2Id]);
